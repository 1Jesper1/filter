# The Filter Package [![Build Status](https://ci.joomla.org/api/badges/joomla-framework/filter/status.svg?ref=refs/heads/3.0-dev)](https://ci.joomla.org/joomla-framework/filter)
